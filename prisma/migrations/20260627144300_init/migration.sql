...
-- CreateIndex
CREATE UNIQUE INDEX "SocialLink_postId_socialId_key" ON "SocialLink"("postId", "socialId");
...
-- AddForeignKey
ALTER TABLE "SocialLink" ADD CONSTRAINT "SocialLink_socialId_fkey" FOREIGN KEY ("socialId") REFERENCES "Social"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
